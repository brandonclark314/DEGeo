...
class GeoCLIP(nn.Module):
    def __init__(self,  input_resolution=224):
        ...
        self.rff_encoding1 = GaussianEncoding(sigma=16.0, input_size=3, encoded_size=256)
        self.rff_encoding2 = GaussianEncoding(sigma=8.0, input_size=3, encoded_size=256)
        self.rff_encoding3 = GaussianEncoding(sigma=4.0, input_size=3, encoded_size=256)
        self.rff_encoding4 = GaussianEncoding(sigma=2.0, input_size=3, encoded_size=256)
        self.rff_encoding5 = GaussianEncoding(sigma=1.0, input_size=3, encoded_size=256)
