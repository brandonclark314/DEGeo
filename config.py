...
def getopt():
    ...
    opt.saved_model = "/home/vi844593/DEGeo/weights/GeoCLIP100K Adam (256) x15 Scene 16.pth"

    opt.size = 224
    opt.n_epochs = 64

    opt.description = 'GeoCLIP100K Adam (256) x15 Scene 16 loss'
    opt.archname = 'CLIP'
    opt.evaluate = False
    opt.scene = True
    opt.hier_eval = True
